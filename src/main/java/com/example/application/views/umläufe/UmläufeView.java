package com.example.application.views.umläufe;
...
@Route(value = "umlaeufe", layout = MainView.class)
@RouteAlias(value = "", layout = MainView.class)
@PageTitle("Umläufe")
public class UmläufeView extends Div {
    ...
    public UmläufeView(@Autowired SamplePersonService samplePersonService) {
